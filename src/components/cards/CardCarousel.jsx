      ...
      <div className="relative">
        {cards.length > 1 && (
          <>
            <button
              onClick={goPrev}
              className="absolute -left-4 top-1/2 -translate-y-1/2 z-10 w-8 h-8 rounded-full bg-white shadow flex items-center justify-center hover:bg-gray-50 transition-colors"
            ...
            <button
              onClick={goNext}
              className="absolute -right-4 top-1/2 -translate-y-1/2 z-10 w-8 h-8 rounded-full bg-white shadow flex items-center justify-center hover:bg-gray-50 transition-colors"
